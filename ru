...
Prefix Subject|| Префикс Тема
Avoid flapping time|| Избегайте взмахов
The time that alerts wait when backend is flapping|| Время ожидания оповещений при колебании бэкэнда
...
When this action is executed a file with system information will be downloaded.|| Когда это действие выполнено, будет загружен файл с системной информацией.
This action may take several seconds, you can continue browsing the GUI.|| Это действие может занять несколько секунд, вы можете продолжить просмотр графического интерфейса.
Select an interface which won't be deleted|| Выберите интерфейс, который не будет удален
This action will destroy all the config, except the selected interface, the backups and the activation certificate.|| Это действие уничтожит все настройки, кроме выбранного интерфейса, резервных копий и сертификата активации.
The current credentials for user root will not be modified.|| Текущие учетные данные пользователя root не будут изменены.
User List|| Список пользователей
Group List|| Список групп
Role List|| Список ролей
Role Settings|| Настройки ролей
Show all permissions|| Показать все разрешения
Hide all permissions|| Скрыть все разрешения
Show permissions|| Показать разрешения
Hide permissions|| Скрыть разрешения
LDAP Server|| Сервер LDAP
Base DN|| Базовый DN
Bind DN|| Bind DN
Scope|| Объем
Bind Password|| Привязать пароль
Filter|| Фильтр
Global Services|| Глобальные услуги
Enable session replication|| Включить репликацию сеанса
Enable Duplicated network|| Включить дублированную сеть
Enable ARP announce|| Включить объявление ARP
Custom Routes|| Пользовательские маршруты
System Routes|| Системные маршруты
Use proxy of new generation|| Используйте прокси нового поколения
Validation Systems|| Системы валидации
AWS Credentials|| Учетные данные AWS
Access Key|| Ключ доступа
Secret Key|| Секретный ключ
Region|| Регион
SSL Certificate|| SSL сертификат
RBAC User|| Пользователь RBAC
RBAC Group|| RBAC Group
RBAC Role|| RBAC Роль
Network Virtual Interface|| Сетевой виртуальный интерфейс
System Service|| Системное обслуживание
Notification|| Уведомление
Host or URL allowed|| Хост или URL разрешены
It will not be used if the HOST/URL field contains a URL|| Он не будет использоваться, если поле HOST / URL содержит URL
Filter used to get the LDAP field that contains the user ID to log in|| Фильтр, используемый для получения поля LDAP, содержащего идентификатор пользователя для входа
The Search Request will be performed against the entry specified as the search base DN.|| Запрос на поиск будет выполнен для записи, указанной в качестве DN базы поиска.
The Search Request will be performed against entries that are immediate subordinates of the entry specified as the search base DN.|| Запрос на поиск будет выполнен для записей, которые являются непосредственными подчиненными записи, указанной в качестве DN базы поиска.
The Search Request will be performed against the search base and all entries below|| Поисковый запрос будет выполнен для базы поиска и всех записей ниже
The new management GUI address is {{param}} please reconnect to GUI in the new URL.|| Новый адрес графического интерфейса управления {{param}}. Пожалуйста, переподключитесь к графическому интерфейсу в новом URL.
The <strong> HTTP service </strong> has been updated successfully.|| Это <strong> HTTP сервис </strong> был успешно обновлен.
The <strong> SSH service </strong> has been updated successfully.|| Это <strong> Служба SSH </strong> был успешно обновлен.
The <strong> SNMP service </strong> has been updated successfully.|| Это <strong> Служба SNMP </strong> был успешно обновлен.
The <strong> global services </strong> have been updated successfully|| Это <strong> глобальные услуги </strong> были успешно обновлены
The <strong> DNS service </strong> has been updated successfully.|| Это <strong> Служба DNS </strong> был успешно обновлен.
The <strong> NTP service </strong> has been updated successfully.|| Это <strong> Служба NTP </strong> был успешно обновлен.
The <strong> Proxy service </strong> has been updated successfully.|| Это <strong> Прокси сервис </strong> был успешно обновлен.
The backup <strong> {{param}} </strong> has been deleted successfully.|| Бэкап <strong> {{param}} </strong> был успешно удален.
The backup <strong> {{param}} </strong> has been applied successfully.|| Бэкап <strong> {{param}} </strong> был успешно применен.
The backup <strong> {{param}} </strong> has been downloaded successfully.|| Бэкап <strong> {{param}} </strong> был успешно загружен.
The backup <strong> {{param}} </strong> has been uploaded successfully.|| Бэкап <strong> {{param}} </strong> был успешно загружен.
The backup <strong> {{param}} </strong> has been created successfully.|| Бэкап <strong> {{param}} </strong> был успешно создан.
The <strong> backends alert </strong> has been applied successfully.|| Это <strong> оповещение о бэкэндах </strong> был успешно применен.
The <strong> cluster alert </strong> has been applied successfully.|| Это <strong> предупреждение кластера </strong> был успешно применен.
The configuration of email has been updated successfully.|| Конфигурация электронной почты была успешно обновлена.
The alert has been updated successfully.|| Предупреждение было успешно обновлено.
The test email has been sent successfully.|| Тестовое письмо успешно отправлено.
The user has been updated successfully.|| Пользователь был успешно обновлен.
The log <strong> {{param}} </strong> has been downloaded successfully.|| Журнал <strong> {{param}} </strong> был успешно загружен.
The <strong> Support Save </strong> has been downloaded successfully.|| Это <strong> Поддержка Сохранить </strong> был успешно загружен.
The user <strong> {{param}} </strong> has been deleted successfully.|| Пользователь <strong> {{param}} </strong> был успешно удален.
The user {{param}} has been created successfully.|| Пользователь {{param}} был успешно создан.
The user {{param}} has been updated successfully.|| Пользователь {{param}} был успешно обновлен.
The group <strong> {{param}} </strong> has been deleted successfully.|| Группа <strong> {{param}} </strong> был успешно удален.
The group {{param}} has been created successfully.|| Группа {{param}} успешно создана.
The group {{param}} has been updated successfully.|| Группа {{param}} успешно обновлена.
The user <strong> {{param}} </strong> has been added to the group successfully.|| Пользователь <strong> {{param}} </strong> был успешно добавлен в группу.
The user <strong> {{param}} </strong> has been removed to the group successfully.|| Пользователь <strong> {{param}} </strong> был успешно удален в группу.
The farm <strong> {{param}} </strong> has been added to the group successfully.|| Ферма <strong> {{param}} </strong> был успешно добавлен в группу.
The farm <strong> {{param}} </strong> has been removed to the group successfully.|| Ферма <strong> {{param}} </strong> был успешно удален в группу.
The interface <strong> {{param}} </strong> has been added to the group successfully.|| Интерфейс <strong> {{param}} </strong> был успешно добавлен в группу.
The interface <strong> {{param}} </strong> has been removed to the group successfully.|| Интерфейс <strong> {{param}} </strong> был успешно удален в группу.
The role <strong> {{param}} </strong> has been deleted successfully.|| Роль <strong> {{param}} </strong> был успешно удален.
The role {{param}} has been created successfully.|| Роль {{param}} успешно создана.
The role {{param}} has been updated successfully.|| Роль {{param}} была успешно обновлена.
The LDAP server has been configured. Please, test the connectivity to confirm that the configuration is correct.|| Сервер LDAP настроен. Пожалуйста, проверьте подключение, чтобы убедиться, что конфигурация правильная.
The connectivity test has been done successfully.|| Тест подключения был успешно выполнен.
The validation system <strong> {{param}} </strong> has been enabled successfully.|| Система валидации <strong> {{param}} </strong> был успешно включен.
The validation system <strong> {{param}} </strong> has been disabled successfully.|| Система валидации <strong> {{param}} </strong> был успешно отключен.
The cluster has been created successfully.|| Кластер был успешно создан.
The cluster has been updated successfully.|| Кластер был успешно обновлен.
The cluster has been destroyed successfully.|| Кластер был успешно уничтожен.
The <strong>local node</strong> has been put in maintenance successfully.|| Это <strong>локальный узел</strong> успешно введен в эксплуатацию.
The <strong>local node</strong> has been enabled successfully.|| Это <strong>локальный узел</strong> был успешно включен.
The AWS credentials have been configured successfully.|| Учетные данные AWS настроены успешно.
The Azure credentials have been configured successfully.|| Учетные данные Azure были успешно настроены.
Are you sure you want to delete the backup {{param}}?|| Вы уверены, что хотите удалить резервную копию {{param}}?
Are you sure you want to delete the selected backups?|| Вы уверены, что хотите удалить выбранные резервные копии?
Are you sure you want to delete the user {{param}}?|| Вы уверены, что хотите удалить пользователя {{param}}?
Are you sure you want to delete the selected users?|| Вы уверены, что хотите удалить выбранных пользователей?
Are you sure you want to delete the group {{param}}?|| Вы уверены, что хотите удалить группу {{param}}?
Are you sure you want to delete the selected groups?|| Вы уверены, что хотите удалить выбранные группы?
Are you sure you want to delete the role {{param}}?|| Вы уверены, что хотите удалить роль {{param}}?
Are you sure you want to delete the selected roles?|| Вы уверены, что хотите удалить выбранные роли?
Are you sure you want to destroy the cluster?|| Вы уверены, что хотите уничтожить кластер?
Dashboard|| Панель
News|| Новости
LSLB|| LSLB
Farms|| Фермы
SSL Certificates|| SSL-сертификаты
Generate csr|| Генерация CSR
Stats|| Статистика
GSLB|| GSLB
DSLB|| DSLB
IPDS|| IPDS
...
Remote Services|| Удаленные Услуги
Cluster|| Кластер
